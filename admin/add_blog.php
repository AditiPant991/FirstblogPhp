...
?>
<div class = "container><h5 class="mb-2 text-gray-800">Blogs</h5>
    <div class="row>
        <div class = "col-xl-7 col-lg-5>
            <div class="card">
            <div class ="card-header"><h6 class="font-weight-bold text-primary mt-2">Publish 
                Blog/Article</h6>
                </div>
            <div class ="card-body">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3"> <textarea required class="form-control" name="blog_body" rows="2" id="blog"></textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <input type="submit" name ="add_blog" value="Add" class="btn btn-primary"> <a href="index.php" class="btn btn-secondary">Back</a>
                    </div>
                </form>
...
if(isset($_POST['add_blog'])){
    ...
    $imagae_ext= strtolower(pathinfo($filename, PATHINFO_EXTENSION));
    $allow_type=['jpg', 'png', 'jpeg'];
    $destination="upload/".$filename;
    $category=mysqli_real_escape_string($config, $_POST['category']);
    if(in_array($imagae_ext, $allow_type)){
        if($size<=2000000){
